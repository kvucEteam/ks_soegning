        ...
        var that = {
            ...
            redraw: function() {
                ...
                particleSystem.eachNode(function(node, pt) {
                    ...
                    if (node.data.color == 'none') ctx.fillStyle = "black"

                    if (node.data.shape == 'dot') {
                        gfx.oval(pt.x - w / 2, pt.y - w / 2, w, w, { fill: ctx.fillStyle })
                        nodeBoxes[node.name] = [pt.x - w / 2, pt.y - w / 2, w, w]
                    } else {
                        gfx.rect((pt.x - w / 2) - 1, (pt.y - 18) - 1, w + 2, 30 + 2, 4, { fill: "#e6e6e6" })
                        gfx.rect(pt.x - w / 2, pt.y - 18, w, 30, 4, { fill: ctx.fillStyle })
                ...
                particleSystem.eachEdge(function(edge, pt1, pt2) {
                    ...
                    ctx.strokeStyle = (color) ? color : "#E7E6E2"
                    ctx.fillStyle = null
